...
export const StyledNavMenuLogoImg = styled.img`
  width: 113.33px;
  height: 17px;
  color: #181818;
`;
...
//NavHomePageButton.jsx NavSighInButton.jsx NavMyPlaylistButton.jsx
...
//NavBurgerButton.jsx
export const StyledNavMenuBurger = styled.div`
  width: 20px;
  height: 36px;
  padding: 13px 0;
  display: -webkit-box;
...
export const StyledNavMenuBurgerLine = styled.span`
